...
let searchSelect = document.querySelector('.search-page__titile');
let categoriesSsearch = document.querySelector('.categories-search');

searchSelect.addEventListener('click', function (e) {
  searchSelect.classList.toggle('_active');
  _slideToggle(categoriesSsearch);
});
